...
import {
  ...
  type OfficialCandidateNameLookup,
...
import {
  ...
  type WriteInTally,
  type WriteInAdjudicatedInvalidTally,
  type WriteInAdjudicatedOfficialCandidateTally,
  type WriteInAdjudicatedWriteInCandidateTally,
  type WriteInPendingTally,
  ...
  type WriteInAdjudicationActionReset,
} from '../types/types';
