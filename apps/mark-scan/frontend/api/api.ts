...
export const startCardlessVoterSession = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.startCardlessVoterSession,
      async onSuccess() {
        // Because we poll auth status with high frequency, this invalidation isn't strictly
        // necessary
        await queryClient.invalidateQueries({
...
export const updateCardlessVoterBallotStyle = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.updateCardlessVoterBallotStyle,
      async onSuccess() {
        // Because we poll auth status with high frequency, this invalidation isn't strictly
        // necessary
        await queryClient.invalidateQueries({
...
export const endCardlessVoterSession = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.endCardlessVoterSession,
      async onSuccess() {
...
export const configureElectionPackageFromUsb = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: () => apiClient.configureElectionPackageFromUsb(),
      async onSuccess() {
        await queryClient.invalidateQueries({
...
export const unconfigureMachine = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: () => apiClient.unconfigureMachine(),
      async onSuccess() {
...
export const printBallot = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.printBallot,
      async onSuccess() {
        await queryClient.invalidateQueries({
...
export const setPollsState = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.setPollsState,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getElectionState.queryKey(),
        });
...
export const setAcceptingPaperState = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.setAcceptingPaperState,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const validateBallot = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.validateBallot,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const confirmSessionEnd = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.confirmSessionEnd,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const invalidateBallot = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.invalidateBallot,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const confirmInvalidateBallot = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.confirmInvalidateBallot,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const confirmBallotBoxEmptied = {
  useMutation() {
    ...
    return useMutation({ mutationFn: apiClient.confirmBallotBoxEmptied });
  },
} as const;
...
export const setPatDeviceIsCalibrated = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.setPatDeviceIsCalibrated,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const startPaperHandlerDiagnostic = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.startPaperHandlerDiagnostic,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const stopPaperHandlerDiagnostic = {
  useMutation() {
    ...
    const queryClient = useQueryClient();
    return useMutation({
      mutationFn: apiClient.stopPaperHandlerDiagnostic,
      async onSuccess() {
        await queryClient.invalidateQueries({
          queryKey: getStateMachineState.queryKey(),
        });
...
export const returnPreprintedBallot = {
  useMutation: () =>
    useMutation({ mutationFn: useApiClient().returnPreprintedBallot }),
} as const;
...
export const getMockPaperHandlerStatus = {
  ...
  useQuery() {
    ...
    React.useEffect(() => {
      void queryClient.invalidateQueries({ queryKey: this.queryKey });
...
export const setMockPaperHandlerStatus = {
  useMutation() {
    ...
    return useMutation({
      mutationFn: apiClient.setMockPaperHandlerStatus,
      async onSuccess() {
        await queryClient.invalidateQueries({
