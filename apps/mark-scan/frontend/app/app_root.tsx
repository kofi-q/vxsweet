...
import { type ElectionState } from '../../backend/types/types';
...
import { AdminScreen } from '../pages/admin/admin_screen';
import { InsertCardScreen } from '../pages/auth/insert_card_screen';
import { PollWorkerScreen } from '../pages/poll-worker/poll_worker_screen';
import { SetupPowerPage } from '../pages/error/setup_power_page';
import { UnconfiguredScreen } from '../pages/auth/unconfigured_screen';
import { SystemAdministratorScreen } from '../pages/admin/system_administrator_screen';
import { UnconfiguredElectionScreenWrapper } from '../pages/auth/unconfigured_election_screen_wrapper';
import { JammedPage } from '../pages/jams/jammed_page';
import { JamClearedPage } from '../pages/jams/jam_cleared_page';
import { BallotInvalidatedPage } from '../pages/invalidation/ballot_invalidated_page';
import { BlankPageInterpretationPage } from '../pages/interpretation/blank_page_interpretation_page';
import { PaperReloadedPage } from '../pages/paper-reload/paper_reloaded_page';
import { CastingBallotPage } from '../pages/casting/casting_ballot_page';
import { BallotSuccessfullyCastPage } from '../pages/casting/ballot_successfully_cast_page';
import { EmptyBallotBoxPage } from '../pages/empty-ballot-box/empty_ballot_box_page';
...
import { NoPaperHandlerPage } from '../pages/error/no_paper_handler_page';
import { ScannerOpenAlarmScreen } from '../pages/scanner-open/scanner_open_alarm_screen';
import { UnrecoverableErrorPage } from '../pages/error/unrecoverable_error_page';
