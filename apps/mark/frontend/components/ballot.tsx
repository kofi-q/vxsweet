...
import { ContestScreen } from '../pages/contest/contest_screen';
import { IdlePage } from '../pages/idle/idle_page';
import { NotFoundPage } from '../pages/not-found/not_found_page';
import { PrintPage } from '../pages/print/print_page';
import { ReviewScreen } from '../pages/review/review_screen';
