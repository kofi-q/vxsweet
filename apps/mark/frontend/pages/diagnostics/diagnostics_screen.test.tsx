jest.mock(
  './accessible_controller',
  (): typeof import('./accessible_controller') => ({
    ...jest.requireActual('./accessible_controller'),
...
import { AccessibleControllerDiagnosticScreen } from './accessible_controller';
import { ApiProvider } from '../../api/api_provider';
import {
  type ApiMock,
  createApiMock,
} from '../../test/helpers/mock_api_client';
import { ACCESSIBLE_CONTROLLER_POLLING_INTERVAL_MS } from '../../api/api';
