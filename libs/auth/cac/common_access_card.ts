...
import { type FileKey, type TpmKey } from '../cryptography/keys';
...
import { type CardStatus, type CheckPinResponse } from '../cards/card';
import { CardReader } from '../cards/card_reader';
import { CERT_EXPIRY_IN_DAYS } from '../cards/certs';
import {
  certDerToPem,
  certPemToDer,
  createCert,
