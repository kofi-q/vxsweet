...
import { tpmOpensslParams } from '../src/tpm';
 ...
 *
 * createCert() --> ../intermediate-scripts/create-cert --> createCertHelper()
 *
 ...
 */
export function createCert(input: CreateCertInput): Promise<Buffer> {
  const scriptPath = path.join(
    __dirname,
    '../intermediate-scripts/create-cert'
  );
 ...
 * Uses a slightly roundabout control flow for permissions purposes:
 *
 * signMessage() --> ../intermediate-scripts/sign-message --> signMessageHelper()
 *
...
export function signMessage({
  ...
  const scriptPath = path.join(
    __dirname,
    '../intermediate-scripts/sign-message'
  );
