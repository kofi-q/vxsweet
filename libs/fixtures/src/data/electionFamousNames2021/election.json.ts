...
export const election: Election = {
  ...
  contests: [
    ...
    {
      id: 'parks-and-recreation-director',
      districtId: 'district-1',
      type: 'candidate',
    ...
    {
      id: 'board-of-alderman',
      districtId: 'district-1',
      type: 'candidate',
      title: 'Board of Alderman',
      seats: 4,
      allowWriteIns: true,
      candidates: [
        {
  ...
  ballotStrings: {
    en: {
      ...
      contestTitle: {
        ...
        'parks-and-recreation-director': 'Parks and Recreation Director',
        'board-of-alderman': 'Board of Alderman',
        'city-council': 'City Council',
      },
      countyName: 'Franklin County',
      districtName: { 'district-1': 'City of Lincoln' },
