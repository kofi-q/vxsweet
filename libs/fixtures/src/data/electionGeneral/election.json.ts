...
export const election: Election = {
  ...
  contests: [
    ...
    },
    {
      ...
      yesOption: {
        id: 'judicial-robert-demergue-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'judicial-robert-demergue-option-no',
        label: 'No',
      },
    },
    {
      ...
      yesOption: {
        id: 'judicial-elmer-hull-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'judicial-elmer-hull-option-no',
        label: 'No',
      },
    },
    {
      ...
      yesOption: {
        id: 'question-a-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'question-a-option-no',
        label: 'No',
      },
    },
    {
      ...
      yesOption: {
        id: 'question-b-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'question-b-option-no',
        label: 'No',
      },
    },
    {
      ...
      yesOption: {
        id: 'question-c-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'question-c-option-no',
        label: 'No',
      },
    },
    {
      ...
      type: 'yesno',
      description:
        '<p>Shall there be an amendment to the State constitution authorizing Franklin and Fromwit Counties to hold referenda on whether to authorize slot machines in existing, licensed pari-mutuel facilities?</p><ol><li><p><strong>Thoroughbred racing</strong></p></li><li><p><em>Greyhound racing</em></p></li><li><p><u>Jai alai</u></p></li><li><p><s>Harness racing</s></p></li></ol><p>Requires implementing legislation:</p><ul><li><p>Proposition 1</p></li><li><p>Repeal Statute C</p></li></ul>',
      yesOption: {
        id: 'proposition-1-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'proposition-1-option-no',
        label: 'No',
      },
    },
    {
      ...
      type: 'yesno',
      description:
        '<p>To upgrade educational facilities at Diablo Valley, and Franklin, shall the Franklin Community College District issue $450 million of bonds at legal interest rates with independent oversight, audits, and all funds spent on local sites?</p><table style="min-width: 0px"><colgroup><col><col></colgroup><tbody><tr><th colspan="1" rowspan="1"><p>Diablo Valley</p></th><th colspan="1" rowspan="1"><p>Franklin</p></th></tr><tr><td colspan="1" rowspan="1"><p>health</p></td><td colspan="1" rowspan="1"><p><strong>science</strong></p></td></tr><tr><td colspan="1" rowspan="1"><p><u>medical</u></p></td><td colspan="1" rowspan="1"><p>technology</p></td></tr></tbody></table><img src="data:image/svg+xml;base64,">',
      yesOption: {
        id: 'measure-101-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'measure-101-option-no',
        label: 'No',
      },
    },
    {
      ...
      yesOption: {
        id: 'measure-102-option-yes',
        label: 'Yes',
      },
      noOption: {
        id: 'measure-102-option-no',
        label: 'No',
      },
    },
  ],
  ...
  ballotStrings: {
    ...
    'zh-Hans': {
      contestDescription: {
        ...
        'proposition-1':
          '<p>是否应修改州宪法，授权富兰克林县和弗罗威特县举行全民公决，决定是否允许在现有的持牌彩池设施中开设老虎机？</p><ol><li><p><strong>纯种赛马</strong></p></li><li><p><em>赛狗</em></p></li><li><p><u>回力球</u></p></li><li><p><s>马具赛马</s></p></li></ol><p>需要实施立法：</p><ul><li><p>提案 1</p></li><li><p>废除法令 C</p></li></ul>',
        'measure-101':
          '<p>为了升级 Diablo Valley 和 Franklin 的教育设施，Franklin 社区学院区是否应以合法利率发行 4.5 亿美元的债券，并进行独立监督和审计，并将所有资金用于本地站点？</p><table style="min-width: 0px"><colgroup><col><col></colgroup><tbody><tr><th colspan="1" rowspan="1"><p>Diablo Valley</p></th><th colspan="1" rowspan="1"><p>Franklin</p></th></tr><tr><td colspan="1" rowspan="1"><p>健康</p></td><td colspan="1" rowspan="1"><p><strong>科学</strong></p></td></tr><tr><td colspan="1" rowspan="1"><p><u>医疗</u></p></td><td colspan="1" rowspan="1"><p>技术</p></td></tr></tbody></table><img src="data:image/svg+xml;base64,">',
      },
      contestOptionLabel: {
        'judicial-robert-demergue-option-yes': '是',
        'judicial-robert-demergue-option-no': '无',
        'judicial-elmer-hull-option-yes': '是',
        'judicial-elmer-hull-option-no': '无',
        'question-a-option-yes': '是',
        'question-a-option-no': '无',
        'question-b-option-yes': '是',
        'question-b-option-no': '无',
        'question-c-option-yes': '是',
        'question-c-option-no': '无',
        'proposition-1-option-yes': '是',
        'proposition-1-option-no': '无',
        'measure-101-option-yes': '是',
        'measure-101-option-no': '无',
        'measure-102-option-yes': '是',
        'measure-102-option-no': '无',
      },
      contestTitle: {
        '102': '措施 102：车辆减排计划',
        president: '总裁和副总裁',
      ...
      hmpbInstructions: '说明',
      hmpbInstructionsToVoteText:
        '要投票，请完整填写您所选项目旁边的椭圆形框。',
      hmpbInstructionsToVoteTitle: '投票：',
      hmpbInstructionsWriteInText:
        '如果要为未出现在选票上的人进行投票，请在“写入候选人“行中写下此人的姓名，并完整填写该行旁边的椭圆形区域。',
    ...
    'zh-Hant': {
      contestDescription: {
        ...
        'question-a':
          '是否應就與不動產改善工程建設有關的損害賠償問題對州憲法進行修訂，並禁止制定限製或損害業主因未進行不動產改善工程建設而造成損害賠償的權利的法律？',
        'question-b':
        ...
        'proposition-1':
          '<p>是否應該對州憲法進行修正案，授權富蘭克林縣和弗羅維特縣就是否在現有的、獲得許可的彩池設施中授權老虎機進行全民公投？ <p><strong >純種馬比賽</strong></p></li><li><p><em>灰狗比賽</em></p></li><li>< p><u>迴力賽< /u></p></li><li><p><s>安全帶賽車</s></p></li></ol><p>需要實施立法：</p>< ul><li><p>提案 1</p></li><li><p>廢除法規 C</p></li></ul>',
        'measure-101':
          '<p>為了升級暗黑破壞神谷和富蘭克林的教育設施，富蘭克林社區學院區是否應以法定利率發行4.5 億美元的債券，並進行獨立監督和審計，並將所有資金用於當地場所？ <table style ="min-width: 0px"><colgroup><col><col></colgroup><tbody><tr><th colspan="1" rowspan="1"><p>暗黑破壞神谷</p> </th><th colspan="1" rowspan="1"><p>富蘭克林</p></th></tr><tr><td colspan="1" rowspan=" 1">< p>健康</p></td><td colspan="1" rowspan="1"><p><strong>科學</strong></p></td></tr ><tr> <td colspan="1" rowspan="1"><p><u>醫療</u></p></td><td colspan="1" rowspan="1">< p>技術< /p></td></tr></tbody></table><img src="data:image/svg+xml;base64,">',
      },
      contestOptionLabel: {
        'judicial-robert-demergue-option-yes': '是',
        'judicial-robert-demergue-option-no': '無',
        'judicial-elmer-hull-option-yes': '是',
        'judicial-elmer-hull-option-no': '無',
        'question-a-option-yes': '是',
        'question-a-option-no': '無',
        'question-b-option-yes': '是',
        'question-b-option-no': '無',
        'question-c-option-yes': '是',
        'question-c-option-no': '無',
        'proposition-1-option-yes': '是',
        'proposition-1-option-no': '無',
        'measure-101-option-yes': '是',
        'measure-101-option-no': '無',
        'measure-102-option-yes': '是',
        'measure-102-option-no': '無',
      },
      contestTitle: {
        '102': '措施 102：車輛減量計劃',
        president: '主席和副主席',
      ...
      hmpbInstructions: '說明',
      hmpbInstructionsToVoteText:
        '要投票，請完整填寫您所選項目旁邊的橢圓形框。',
      hmpbInstructionsToVoteTitle: '投票：',
      hmpbInstructionsWriteInText:
        '如果要為未出現在選票上的人進行投票，請在「寫入候選人「行中寫下此人的姓名，並完整填寫該行旁邊的橢圓形區域。',
    ...
    'es-US': {
      contestDescription: {
        '102':
          '¿Debería renovarse el Programa de Reducción de Vehículos del Condado de Franklin y las tarifas de registro de vehículos (un dólar por vehículo y dos dólares adicionales para ciertos vehículos comerciales pagaderos al momento del registro de un vehículo) por un período de diez años a partir del 1 de julio de 2021, para la reducción y remoción de vehículos abandonados, destrozados, desmantelados o inoperativos?',
        'judicial-robert-demergue':
          '¿Debe Robert Demergue mantenerse como Presidente del Tribunal de Apelaciones de Hamilton?',
        'judicial-elmer-hull':
          '¿Debe Elmer Hull mantenerse como juez asociado del Tribunal de Apelaciones de Hamilton?',
        'question-a':
          '¿Debería haber una enmienda a la constitución del Estado en relación con la recuperación de daños relacionados con la construcción de mejoras de propiedad inmobiliaria y, en relación con ello, prohibir las leyes que limiten o perjudiquen el derecho del propietario de una propiedad a recuperar los daños causados por la falta de construcción de una mejora de manera buena y profesional?',
        'question-b':
          '¿Se deben introducir modificaciones a la constitución estatal con el fin de garantizar colectivamente la separación del poder gubernamental entre las tres ramas del gobierno estatal: la rama legislativa, la rama ejecutiva y la rama judicial? \n\na. El Artículo III, Sección 6 de la Constitución se modificará para que se lea como sigue: \n\nSección 6. Ocupación de cargos en otros gobiernos \n\nLos senadores y representantes no podrán ocupar otros cargos designados en el gobierno estatal.',
        'question-c':
          '¿Debería haber una enmienda a la constitución estatal que permita a la legislatura estatal promulgar leyes que limiten el monto de los daños por pérdidas no económicas que podrían otorgarse por lesiones o muerte causadas por un proveedor de atención médica?',
        'proposition-1':
          '<p>¿Debería haber una enmienda a la constitución estatal que autorice a los condados de Franklin y Fromwit a realizar referendos sobre si autorizar o no las máquinas tragamonedas en las instalaciones de apuestas mutuas existentes y autorizadas?</p><ol><li><p><strong>Carreras de pura sangre</strong></p></li><li><p><em>Carreras de galgos</em></p></li><li><p><u>Jai alai</u></p></li><li><p><s>Carreras de arnés</s></p></li></ol><p>Requiere legislación de implementación:</p><ul><li><p>Propuesta 1</p></li><li><p>Derogar el Estatuto C</p></li></ul>',
        'measure-101':
          '<p>Para mejorar las instalaciones educativas en Diablo Valley y Franklin, ¿debería el Distrito de Colegios Comunitarios de Franklin emitir $450 millones en bonos a tasas de interés legales con supervisión independiente, auditorías y todos los fondos gastados en sitios locales?</p><table style="min-width: 0px"><colgroup><col><col></colgroup><tbody><tr><th colspan="1" rowspan="1"><p>Diablo Valley</p></th><th colspan="1" rowspan="1"><p>Franklin</p></th></tr><tr><td colspan="1" rowspan="1"><p>salud</p></td><td colspan="1" rowspan="1"><p><strong>ciencia</strong></p></td></tr><tr><td colspan="1" rowspan="1"><p><u>médica</u></p></td><td colspan="1" rowspan="1"><p>tecnología</p></td></tr></tbody></table><img src="data:image/svg+xml;base64,">',
      },
      contestOptionLabel: {
      ...
      contestTitle: {
        ...
        'judicial-robert-demergue':
          '¿Debemos mantener a Robert Demergue como presidente del Tribunal Supremo?',
        'judicial-elmer-hull': '¿Mantener a Elmer Hull como juez asociado?',
        'question-a': 'Pregunta A: Recuperación de daños materiales',
      ...
      precinctName: {
        '20': 'Springfield del Sur',
        '21': 'Springfield del Norte',
        '23': 'Centro de Springfield',
      },
      ...
      hmpbInstructionsWriteInText:
        'Para votar por una persona cuyo nombre no está en la boleta, escribe el nombre de la persona en la línea "Candidato por Escrito" y llena completamente el óvalo junto a la línea.',
