// Vendored from https://github.com/dcuddeback/libudev-sys
...
extern "C" {
    ...
    pub fn udev_monitor_new_from_netlink(udev: *mut udev, name: *const c_char)
        -> *mut udev_monitor;
...
#[cfg(hwdb)]
mod hwdb {
    use super::libc::{c_char, c_uint, c_void};
