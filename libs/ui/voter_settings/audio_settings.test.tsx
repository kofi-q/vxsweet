jest.mock(
  '../ui_strings/audio-controls/toggle_audio_button',
  (): typeof import('../ui_strings/audio-controls/toggle_audio_button') => ({
    ...jest.requireActual('../ui_strings/audio-controls/toggle_audio_button'),
